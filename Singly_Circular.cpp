...
class ScircularLL
{
    ...
    public:
        ...
        ScircularLL :: ScircularLL()
         ...
         void ScircularLL :: InsertFirst(int No)
         {
             PNODE newn =new NODE;
             newn->data=No;
             newn->next=NULL;
         ...
         void ScircularLL :: InsertLast(int No)
         {
              PNODE newn =new NODE;
             newn->data=No;
             newn->next=NULL;
         ...
         void ScircularLL :: InsertAtPos(int No,int pos)
         {
             if((pos < 1) || (pos > (size+1)))
             {
                 return;
         ...
         void ScircularLL :: DeleteAtPos(int pos)
         {
             if((pos < 1) || (pos > size))
             {
                 return;
